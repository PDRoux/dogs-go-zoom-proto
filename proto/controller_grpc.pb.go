...
const (
	Controller_Move_FullMethodName = "/Controller/Move"
	Controller_Stop_FullMethodName = "/Controller/Stop"
)
...
type ControllerClient interface {
	...
	Stop(ctx context.Context, in *StopRequest, opts ...grpc.CallOption) (*MoveResponse, error)
}
...
func (c *controllerClient) Move(ctx context.Context, in *MoveRequest, opts ...grpc.CallOption) (*MoveResponse, error) {
...
func (c *controllerClient) Stop(ctx context.Context, in *StopRequest, opts ...grpc.CallOption) (*MoveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MoveResponse)
...
type ControllerServer interface {
	...
	Stop(context.Context, *StopRequest) (*MoveResponse, error)
...
func (UnimplementedControllerServer) Move(context.Context, *MoveRequest) (*MoveResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Move not implemented")
}
func (UnimplementedControllerServer) Stop(context.Context, *StopRequest) (*MoveResponse, error) {
